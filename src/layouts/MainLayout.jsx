          ...
          <div className="suggestion-main-div">
            ...
            >
              ...
              <div className="d-flex align-items-center mb-3">
                ...
                <button className="btn  text-primary ms-auto p-0"  style={{fontSize: "12px", color:"#85A1FF"}}>
                  Switch
                </button>
              </div>
              ...
              <div className="d-flex justify-content-between align-items-center mb-2">
                ...
                <button className="btn text-light p-0"  style={{fontSize: "12px"}}>See All</button>
              </div>
              ...
              {suggestions.map((s, i) => (
                <div key={i} className="d-flex align-items-center mb-3">
                  ...
                  <button className="btn  text-primary ms-auto p-0" style={{fontSize: "12px"}}>
                    Follow
                  </button>
                </div>
              ))}
              ...
              {/* Footer */}
              <div className="text-secondary mt-4" style={{ fontSize: "12px" }}>
                <p>
